...
export function Header() {
  return (
    <div className="rounded-2xl bg-gl-green-opacity-50 p-2">
      <Link href={'/'} className="flex w-fit items-center gap-x-2.5 rounded-lg hover:bg-gl-green-opacity-30">
        ...
        <div className="flex items-end gap-x-3 pr-2">
          ...
          <span className="text-layout-12-r text-gl-grayscale-300">Administration</span>
        </div>
      </Link>
    </div>
  )
