  ...
  theme: {
    extend: {
      fontSize: {
        ...
        'button-14-l': ['14px', { lineHeight: '100%', letterSpacing: '0%', fontWeight: '400' }],
        'button-16-m': ['16px', { lineHeight: '100%', letterSpacing: '0%', fontWeight: '500' }],
        'modal-18-b': ['18px', { lineHeight: '100%', letterSpacing: '0%', fontWeight: '700' }],
      },
      colors: {
        gl: {
